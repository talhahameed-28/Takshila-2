      ...
      return (
            ...
            <section className="bg-[#e5e2df]">
              <div className="max-w-5xl font-serif mx-auto px-6 md:px-10 py-32 leading-relaxed text-[#1a1a1a]/90 terms-content">
                     <h1 className="text-3xl md:text-4xl font-light mb-6">Privacy policy</h1>
            
                    <p>Last updated: May 31, 2025</p>

                    <p>This Privacy Policy describes how My Store (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from takshila.co (the "Site") or otherwise communicate with us regarding the Site (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.</p>
                    ...
                    <h2 className="text-2xl font-bold mb-2 mt-2">Changes to This Privacy Policy</h2>
                    ...
                    <h3 className="text-2xl font-bold mb-2 mt-2">What Personal Information We Collect</h3>
                    ...
                    <h3 className="text-2xl font-bold mb-2 mt-2">Information We Collect Directly from You</h3>
                    ...
                    <h3 className="text-2xl font-bold mb-2 mt-2">Information We Collect about Your Usage</h3>
                    ...
                    <h3 className="text-2xl font-bold mb-2 mt-2">Information We Obtain from Third Parties</h3>
                    ...
                    <h3 className="text-2xl font-bold mb-2 mt-2">How We Use Your Personal Information</h3>
                    <ul>
                        <li>
                    ...
                    <h2 className="text-2xl font-bold mb-2 mt-2">Cookies</h2>
                    ...
                    <h2 className="text-2xl font-bold mb-2 mt-2">How We Disclose Personal Information</h2>
                    ...
                    <p>We have in the past 12 months disclosed the following categories of personal information and sensitive personal information about users for the purposes set out above in <i>"How we Collect and Use your Personal Information"</i> and <i>"How we Disclose Personal Information"</i>:</p>
                     <h4 className="text-xl font-bold mb-2 mt-2"> Category </h4>
                     <ul>
                         ...
                         <h4 className="text-xl font-bold mb-2 mt-2"> Categories of Recipients</h4>
                            <ul>
                    ...
                    <p>We have “sold” and “shared” (as those terms are defined in applicable law) personal information over the preceding 12 months for the purpose of engaging in advertising and marketing activities, as follows.</p>
                     ...
                     <h4 className="text-xl font-bold mb-2 mt-2"> Category of Personal Information </h4>
                    
                        <ul>
                            <li> Identifiers such as name, e-mail address and phone number </li>
                    ...
                    <h2 className="text-2xl font-bold mb-2 mt-2">Third Party Websites and Links</h2>
                    ...
                    <h2 className="text-2xl font-bold mb-2 mt-2">Children's Data</h2>
                    ...
                    <h2 className="text-2xl font-bold mb-2 mt-2">Security and Retention of Your Information</h2>
                    ...
                    <h2 className="text-2xl font-bold mb-2 mt-2">Complaints</h2>
                    ...
                    <h2 className="text-2xl font-bold mb-2 mt-2">Contact</h2>
                    <p>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at aikanshtyagi@takshila.co or contact us at 45 Federal Street, Salem, MA, 01970, US.</p>
